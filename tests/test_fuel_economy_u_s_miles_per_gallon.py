...
class TestUSMilesPerGallonMethods(unittest.TestCase):
	...
	def test_convert_known_u_s_miles_per_gallon_to_litres_per100_kilometres(self):
		self.assertAlmostEqual(2.11905, units.fuel_economy.u_s_miles_per_gallon.to_litres_per100_kilometres(111.0), places=1)
		self.assertAlmostEqual(588.036, units.fuel_economy.u_s_miles_per_gallon.to_litres_per100_kilometres(0.4), places=1)
		self.assertAlmostEqual(45.2336, units.fuel_economy.u_s_miles_per_gallon.to_litres_per100_kilometres(5.2), places=1)
